...
class AdministratorDashboardCategory extends React.Component {
            ...
            <Container>
                ...
                <Modal size="lg" centered show={ this.state.addModal.visible } onHide={ () => this.setAddModalVisibleState(false) }>
                    ...
                    <Modal.Body>
                        ...
                        <Form.Group>
                            ...
                            <Form.Control id="imagePath" type="text" value={ this.state.addModal.imagePath }
                        ...
                        <Form.Group>
                            ...
                            <Form.Control id="parentCategoryId" as="select" value={ this.state.addModal.parentCategoryId?.toString() }
                                ...
                                <option value="null">No Root Category</option>
                                { this.state.categories.map(category => (
                ...
                <Modal size="lg" centered show={ this.state.editModal.visible } onHide={ () => this.setEditModalVisibleState(false) }>
                    ...
                    <Modal.Body>
                        ...
                        <Form.Group>
                            <Form.Label htmlFor="imagePath">Image URL</Form.Label>
                            <Form.Control id="imagePath" type="text" value={ this.state.editModal.imagePath }
                        ...
                        <Form.Group>
                            <Button variant="primary" onClick={ () => this.doEditCategory() }>
                                <FontAwesomeIcon icon={ faPlus } /> Edit category
                            </Button>
                        </Form.Group>
    ...
    private doAddCategory() {
        ...
        .then((res: ApiResponse) => {
            ...
            if (res.status === "error") {
                this.setAddModalStringFieldState('mesage', JSON.stringify(res.data))
                return;
            }
