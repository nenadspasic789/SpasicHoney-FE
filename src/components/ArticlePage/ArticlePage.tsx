...
interface ArticlePageProperies {
    match: {
        params: {
            aId: number;
        }
...
export default class ArticlePage extends React.Component<ArticlePageProperies> {
    state: ArticlePageState;

    constructor(props: Readonly<ArticlePageProperies>) {
        super(props);
    ...
    componentDidUpdate(oldProperties: ArticlePageProperies) {
    ...
    private getArticleData() {
        api('api/article/' + this.props.match.params.aId, 'get', {}, 'user')
